...
geomap(.coo extension files): 

input file- To select the output matched coordinate files, will give database file as output
...
database file(.dat)- to select the database file
...
input file(.fits)- select the aligned fits file and the respective preprocessed fits file of the selected refernce file
